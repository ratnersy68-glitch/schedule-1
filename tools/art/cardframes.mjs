...
const commonDefs = (extra = []) => defs([
  ...
  linearGradient('metal', [['0%', '#FFFFFF', 0.85], ['24%', TS], ['48%', '#FFFFFF', 0.75], ['70%', TS], ['100%', '#FFFFFF', 0.6]], { x1: '0%', y1: '0%', x2: '100%', y2: '100%' }),
...
const BG = {
  ...
  treasures: () => [
    ...
    el('ellipse', { cx: W / 2, cy: H * 0.4, rx: W * 0.42, ry: H * 0.3, fill: TS, opacity: 0.12 }),
    vignette(), grain(0.07),
  ],
  flawless: () => [
    commonDefs(),
    el('rect', { width: W, height: H, fill: '#050506' }),
    el('ellipse', { cx: W / 2, cy: H * 0.36, rx: W * 0.46, ry: H * 0.32, fill: TP, opacity: 0.55 }),
...
const FG = {
  optic: () => [
    ...
    el('path', { d: `M0,${H - 16}L${W},${H - 16}v16H0Z`, fill: TS, opacity: 0.85 }),
    frameEdge(TS, 10),
  ],
  select: () => [
    commonDefs(),
    el('path', { d: roundRect(26, 26, W - 52, H - 52, 14), fill: 'none', stroke: 'url(#metal)', 'stroke-width': 7 }),
    el('path', { d: roundRect(44, 44, W - 88, H - 88, 8), fill: 'none', stroke: TA, 'stroke-width': 2, opacity: 0.35 }),
    el('path', { d: `M60,860h${W - 120}v138H60Z`, fill: TPD, opacity: 0.88 }),
    el('path', { d: `M60,860h${W - 120}v8H60Z`, fill: 'url(#metal)' }),
    el('path', { d: `M${W / 2 - 120},26l40,44h-80Z`, fill: TS, opacity: 0.8 }),
    frameEdge(TA, 6, 0.22),
  ],
  prizm: () => [
    commonDefs(),
  ...
  treasures: () => [
    commonDefs(),
    el('path', { d: roundRect(16, 16, W - 32, H - 32, 6), fill: 'none', stroke: 'url(#metal)', 'stroke-width': 22 }),
    el('path', { d: roundRect(46, 46, W - 92, H - 92, 4), fill: 'none', stroke: TS, 'stroke-width': 3, opacity: 0.75 }),
    ...[[46, 46, 1, 1], [W - 46, 46, -1, 1], [46, H - 46, 1, -1], [W - 46, H - 46, -1, -1]].map(([x, y, sx, sy]) => el('path', {
      d: `M${x},${y}l${44 * sx},0q${-30 * sx},${16 * sy} ${-30 * sx},${44 * sy}Z`, fill: TS, opacity: 0.85,
    })),
  ...
  prospect: () => [
    commonDefs(),
    el('path', { d: roundRect(20, 20, W - 40, H - 40, 16), fill: 'none', stroke: TA, 'stroke-width': 9, 'stroke-opacity': 0.9 }),
    el('path', { d: `M44,868h${W - 88}v146H44Z`, fill: TPD, opacity: 0.88 }),
    el('path', { d: 'M44,44h176l-30,58H44Z', fill: TS, opacity: 0.92 }),
    el('text', { x: 76, y: 86, 'font-family': HEADLINE, 'font-size': 40, 'font-weight': 900, fill: '#0B0E13' }, '1ST'),
    frameEdge(TS, 5, 0.4),
  ],
  chrome: () => [
    commonDefs(),
    el('path', { d: roundRect(14, 14, W - 28, H - 28, 8), fill: 'none', stroke: TA, 'stroke-width': 12, 'stroke-opacity': 0.92 }),
  ...
  finest: () => [
    ...
    el('path', { d: `M${W - 150},52l90,90M${W - 60},52l-90,90`, stroke: TS, 'stroke-width': 6, opacity: 0.55 }),
  ],
};
