...
static func data() -> Dictionary:
	return {
		...
		"ferro_silt": {
			...
			"color": Color(0.44, 0.46, 0.48), "icon": "FS", "tags": ["base"],
		},
		"tide_ash": {
			"name": "Tide Ash",
			...
			"contraband": false, "heat": 0.0, "tier": 1,
			"color": Color(0.58, 0.57, 0.53), "icon": "TA", "tags": ["base", "filler"],
		},
		"bloomspore": {
			...
			"contraband": false, "heat": 0.0, "tier": 1,
			"color": Color(0.4, 0.85, 0.6), "icon": "BS", "tags": ["culture"],
		},
		"binder_resin": {
			"name": "Binder Resin",
			...
			"contraband": false, "heat": 0.0, "tier": 1,
			"color": Color(0.85, 0.83, 0.7), "icon": "BR", "tags": ["binder"],
		},
		"chromatic_salt": {
			"name": "Chromatic Salt",
			...
			"color": Color(0.4, 0.7, 1.0), "icon": "CS", "tags": ["additive", "colour"],
		},
		"cryo_gel": {
			"name": "Cryo-Gel",
			...
			"color": Color(0.7, 0.92, 0.96), "icon": "CG", "tags": ["additive", "stabiliser"],
		},
		"voltaic_dust": {
			"name": "Voltaic Dust",
			...
			"color": Color(1.0, 0.82, 0.3), "icon": "VD", "tags": ["additive", "potency"],
		},
		"prism_flake": {
			"name": "Prism Flake",
			...
			"color": Color(0.8, 0.5, 1.0), "icon": "PF", "tags": ["additive", "rare"],
		},
		"harbor_solvent": {
			...
			"contraband": false, "heat": 0.0, "tier": 2,
			"color": Color(0.75, 0.9, 0.55), "icon": "HS", "tags": ["additive", "purity"],
		},
		...
		"pale_shard": {
			...
			"color": Color(0.85, 0.9, 0.95), "icon": "PS", "tags": ["lumen"],
		},
		"cobalt_bloom": {
			"name": "Cobalt Bloom",
			...
			"color": Color(0.25, 0.55, 1.0), "icon": "CB", "tags": ["lumen"],
		},
		"aurora_prism": {
			"name": "Aurora Prism",
			...
			"color": Color(0.5, 0.85, 0.8), "icon": "AP", "tags": ["lumen", "premium"],
		},
		"solar_halo": {
			"name": "Solar Halo",
			...
			"color": Color(1.0, 0.75, 0.25), "icon": "SH", "tags": ["lumen", "premium"],
		},
		"midnight_veil": {
			"name": "Midnight Veil",
			...
			"color": Color(0.45, 0.3, 0.75), "icon": "MV", "tags": ["lumen", "legendary"],
		},
		...
		"paper_wrap": {
			...
			"contraband": false, "heat": 0.0, "tier": 1,
			"color": Color(0.82, 0.76, 0.6), "icon": "WX",
		...
		"vac_pouch": {
			...
			"contraband": false, "heat": 0.0, "tier": 2,
			"color": Color(0.35, 0.4, 0.45), "icon": "VP",
		...
		"shell_case": {
			...
			"color": Color(0.2, 0.55, 0.6), "icon": "SC",
		...
		"courier_box": {
			...
			"color": Color(0.55, 0.45, 0.3), "icon": "CX",
		...
		"volt_tin": {
			...
			"contraband": false, "heat": 0.0, "tier": 1,
			"color": Color(0.9, 0.5, 0.2), "icon": "VT",
		...
		"field_patch": {
			...
			"contraband": false, "heat": 0.0, "tier": 1,
			"color": Color(0.9, 0.3, 0.35), "icon": "FP",
		...
		"burner_sim": {
			...
			"color": Color(0.4, 0.85, 0.9), "icon": "SM",
		...
		"ledger_scrub": {
			...
			"color": Color(0.6, 0.9, 0.5), "icon": "LG",
		...
		"lockup_key": {
			...
			"contraband": false, "heat": 0.0, "tier": 1,
			"color": Color(0.85, 0.7, 0.35), "icon": "KY", "tags": ["key", "quest"],
		},
		"survey_slate": {
			"name": "Survey Slate",
			...
			"color": Color(0.35, 0.65, 0.8), "icon": "SV", "tags": ["quest"],
		},
		"tidewell_ledger": {
			...
			"color": Color(0.75, 0.3, 0.3), "icon": "TL", "tags": ["quest"],
		},
		"scrap_bundle": {
			"name": "Scrap Bundle",
			...
			"contraband": false, "heat": 0.0, "tier": 1,
			"color": Color(0.5, 0.45, 0.4), "icon": "SB", "tags": ["junk"],
		},
	}
